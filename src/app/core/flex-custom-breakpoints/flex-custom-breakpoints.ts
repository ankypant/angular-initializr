...
const CUSTOM_BREAKPOINTS = [
  {
    alias: 'xs',
    mediaQuery: 'screen and (min-width: 0px) and (max-width: 767.9px)',
    priority: 1000,
  },
  {
    alias: 'sm',
    mediaQuery: 'screen and (min-width: 768px) and (max-width: 959.9px)',
    priority: 900,
  },
  {
    alias: 'md',
...
export const FlexCustomBreakpointsProvider = {
  provide: BREAKPOINT,
